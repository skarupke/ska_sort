...
TEST_CASE("counting_sort.simple")
{
    ...
    REQUIRE_EQ(to_sort, result);
}

TEST_CASE("counting_sort.string")
{
...
TEST_CASE("radix_sort.uint8_256_items")
{
...
TEST_CASE("radix_sort.u16string")
{
...
TEST_CASE("radix_sort.u32string")
{
...
TEST_CASE("radix_sort.int32")
{
    ...
    if (which_buffer)
        ...
        std::sort(result.begin(), result.end());
    REQUIRE_EQ(result, to_sort);
}

TEST_CASE("radix_sort.uint32")
{
...
TEST_CASE("radix_sort.int64")
{
    std::vector<int64_t> to_sort = { 5, 6, 19, std::numeric_limits<std::int32_t>::lowest(), std::numeric_limits<int64_t>::lowest(), -1000000000000, 1000000000000, std::numeric_limits<int32_t>::max(), std::numeric_limits<int64_t>::max(), -4, 2, 5, 0, -55, 7, 1000, 23, 6, 8, 127, -128, -129, -256, 32768, -32769, -32768, 32767, 99, 1000000, -1000001, std::numeric_limits<int>::lowest(), std::numeric_limits<int>::max(), std::numeric_limits<int>::max() - 1, std::numeric_limits<int>::lowest() + 1 };
...
TEST_CASE("radix_sort.pair_other_direction")
{
...
TEST_CASE("radix_sort.reference")
{
...
TEST_CASE("radix_sort.pair_reference")
{
    std::vector<std::pair<int, bool>> to_sort = { { 5, true }, { 5, false }, { 6, false }, { 7, true }, { 4, false }, { 4, true } };
    std::vector<std::pair<int, bool>> result(to_sort.size());
...
TEST_CASE("radix_sort.tuple_reference")
{
    std::vector<std::tuple<bool, int, bool>> to_sort = { std::tuple<bool, int, bool>{ true, 5, true }, std::tuple<bool, int, bool>{ true, 5, false }, std::tuple<bool, int, bool>{ false, 6, false }, std::tuple<bool, int, bool>{ true, 7, true }, std::tuple<bool, int, bool>{ true, 4, false }, std::tuple<bool, int, bool>{ false, 4, true }, std::tuple<bool, int, bool>{ false, 5, false } };
    std::vector<std::tuple<bool, int, bool>> result(to_sort.size());
    bool which_buffer = radix_sort(to_sort.begin(), to_sort.end(), result.begin(), [](auto & i) -> decltype(auto) { return i; });
...
TEST_CASE("radix_sort.std_array")
{
...
TEST_CASE("radix_sort.move_only")
{
    ...
    {
        if (which_buffer)
            REQUIRE_EQ(sorted[i], *result[i]);
        else
            REQUIRE_EQ(sorted[i], *to_sort[i]);
    }
}

TEST_CASE("radix_sort.vector_bool")
{
...
TEST_CASE("inplace_radix_sort.uint8")
{
    std::vector<uint8_t> to_sort = { 5, 6, 19, 2, 5, 0, 7, 23, 6, 255, 8, 99 };
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
}

TEST_CASE("inplace_radix_sort.int8")
{
    std::vector<int8_t> to_sort = { 5, 6, 19, -4, 2, 5, 0, -55, 7, 23, 6, 8, 127, -128, 99 };
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
TEST_CASE("inplace_radix_sort.text")
{
    std::string to_sort = "Hello, World!";
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
TEST_CASE("inplace_radix_sort.u16string")
{
    std::u16string to_sort = u"Hello, World!";
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
TEST_CASE("inplace_radix_sort.u32string")
{
    std::u32string to_sort = U"Hello, World!";
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
TEST_CASE("inplace_radix_sort.int16")
{
    std::vector<int16_t> to_sort = { 5, 6, 19, -4, 2, 5, 0, -55, 7, 1000, 23, 6, 8, 127, -128, -129, -256, -32768, 32767, 99 };
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
TEST_CASE("inplace_radix_sort.uint16")
{
    std::vector<uint16_t> to_sort = { 5, 6, 19, 2, 5, 7, 0, 23, 6, 256, 255, 8, 99, 1024, 65535, 65534 };
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
TEST_CASE("inplace_radix_sort.int32")
{
    std::vector<int32_t> to_sort = { 5, 6, 19, -4, 2, 5, 0, -55, 7, 1000, 23, 6, 8, 127, -128, -129, -256, 32768, -32769, -32768, 32767, 99, 1000000, -1000001, std::numeric_limits<int>::lowest(), std::numeric_limits<int>::max(), std::numeric_limits<int>::max() - 1, std::numeric_limits<int>::lowest() + 1 };
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
TEST_CASE("inplace_radix_sort.uint32")
{
    std::vector<uint32_t> to_sort = { 5, 6, 19, 2, 5, 7, 0, 23, 6, 256, 255, 8, 99, 1024, 65536, 65535, 65534, 1000000, std::numeric_limits<unsigned int>::max() };
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
TEST_CASE("inplace_radix_sort.int64")
{
    std::vector<int64_t> to_sort = { 5, 6, 19, std::numeric_limits<std::int32_t>::lowest(), std::numeric_limits<int64_t>::lowest(), -1000000000000, 1000000000000, std::numeric_limits<int32_t>::max(), std::numeric_limits<int64_t>::max(), -4, 2, 5, 0, -55, 7, 1000, 23, 6, 8, 127, -128, -129, -256, 32768, -32769, -32768, 32767, 99, 1000000, -1000001, std::numeric_limits<int>::lowest(), std::numeric_limits<int>::max(), std::numeric_limits<int>::max() - 1, std::numeric_limits<int>::lowest() + 1 };
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
TEST_CASE("inplace_radix_sort.uint64")
{
    std::vector<uint64_t> to_sort = { 5, 6, 19, 2, 5, 7, 0, std::numeric_limits<uint32_t>::max() + 1, 1000000000000, std::numeric_limits<uint64_t>::max(), 23, 6, 256, 255, 8, 99, 1024, 65536, 65535, 65534, 1000000, std::numeric_limits<unsigned int>::max() };
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
TEST_CASE("inplace_radix_sort.float")
{
    std::vector<float> to_sort = { 5, 6, 19, std::numeric_limits<float>::infinity(), -std::numeric_limits<float>::infinity(), -4, 2, 5, 0, -55, 7, 1000, 23, 6, 8, 127, -128, -129, -256, 32768, -32769, -32768, 32767, 99, 1000000, -1000001, 0.1f, 2.5f, 17.8f, -12.4f, -0.0000002f, -0.0f, -777777777.7f, 444444444444.4f };
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
TEST_CASE("inplace_radix_sort.double")
{
    std::vector<double> to_sort = { 5, 6, 19, std::numeric_limits<double>::infinity(), -std::numeric_limits<double>::infinity(), -4, 2, 5, 0, -55, 7, 1000, 23, 6, 8, 127, -128, -129, -256, 32768, -32769, -32768, 32767, 99, 1000000, -1000001, 0.1, 2.5, 17.8, -12.4, -0.0000002, -0.0, -777777777.7, 444444444444.4 };
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
TEST_CASE("inplace_radix_sort.vector_bool")
{
    std::vector<bool> to_sort = { true, false, true, true, false, true, true, true, false, true, false, false };
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
TEST_CASE("inplace_radix_sort.pair")
{
...
TEST_CASE("inplace_radix_sort.pair_other_direction")
{
...
TEST_CASE("inplace_radix_sort.reference")
{
    std::vector<int> to_sort = { 6, 5, 4, 3, 2, 1 };
...
TEST_CASE("inplace_radix_sort.pair_reference")
{
    std::vector<std::pair<int, bool>> to_sort = { { 5, true }, { 5, false }, { 6, false }, { 7, true }, { 4, false }, { 4, true } };
...
TEST_CASE("inplace_radix_sort.move_only")
{
    std::vector<std::unique_ptr<int>> to_sort;
    to_sort.push_back(std::make_unique<int>(5));
    to_sort.push_back(std::make_unique<int>(0));
...
#ifdef FULL_TESTS
TEST_CASE("inplace_radix_sort.tuple")
{
    std::vector<std::tuple<bool, int, bool>> to_sort = { std::tuple<bool, int, bool>{ true, 5, true }, std::tuple<bool, int, bool>{ true, 5, false }, std::tuple<bool, int, bool>{ false, 6, false }, std::tuple<bool, int, bool>{ true, 7, true }, std::tuple<bool, int, bool>{ true, 4, false }, std::tuple<bool, int, bool>{ false, 4, true }, std::tuple<bool, int, bool>{ false, 5, false } };
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
#ifdef FULL_TESTS
TEST_CASE("inplace_radix_sort.nested_tuple")
{
...
TEST_CASE("inplace_radix_sort.string")
{
...
TEST_CASE("inplace_radix_sort.vector")
{
...
#ifdef FULL_TESTS
TEST_CASE("inplace_radix_sort.string_in_vector")
{
    ...
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
    std::sort(copy.begin(), copy.end());
    REQUIRE_EQ(copy, to_sort);
}
#endif

#ifdef FULL_TESTS
TEST_CASE("inplace_radix_sort.vector_tuple_string")
{
...
TEST_CASE("inplace_radix_sort.std_array")
{
    std::vector<std::array<float, 4>> to_sort = { {{ 1.0f, 2.0f, 3.0f, 4.0f }}, {{ 0.0f, 3.0f, 4.0f, 5.0f }}, {{ 1.0f, 1.5f, 2.0f, 2.5f }}, {{ 1.0f, 2.0f, 2.5f, 4.0f }}, {{ 1.0f, 2.0f, 2.5f, 3.5f }}, {{ 0.0f, 3.0f, 4.5f, 4.5f }} };
    inplace_radix_sort(to_sort.begin(), to_sort.end());
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
...
TEST_CASE("inplace_radix_sort.pointers")
{
...
/*#include <list>
TEST_CASE("inplace_radix_sort.vector_of_list")
{
...
TEST_CASE("inplace_radix_sort.vector_of_movables")
{
...
TEST_CASE("radix_sort.movables")
{
    ...
    if (which_buffer)
        REQUIRE_UNARY(std::is_sorted(buffer.begin(), buffer.end()));
    else
        REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end()));
}

#ifdef FULL_TESTS
TEST_CASE("inplace_radix_sort.vector_of_vector_of_movables")
{
...
#ifdef FULL_TESTS
TEST_CASE("inplace_radix_sort.vector_vector_vector")
{
...
TEST_CASE("inplace_radix_sort.no_copy")
{
    ...
    REQUIRE_UNARY(std::is_sorted(to_sort.begin(), to_sort.end(), sort_by_last_name));
}
